...
from ultralytics.yolo.utils import DEFAULT_CFG, RANK, colorstr, IterableSimpleNamespace, yaml_load
...
def train(cfg, use_python=False):
    ...
    data = cfg.data or 'VOC.yaml'  # or yolo.ClassificationDataset("mnist")
...
if __name__ == '__main__':
    train(cfg='cfg/dior_default.yaml')
